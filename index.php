<!DOCTYPE html>
	...
	<body>
		...
		<h2>Use case</h2>
		<p>Robert has got on to Amazon, navigated to the data phones and clicked on the link for a Nexus 6. Robert is interested, but the phone is a little pricey. Robert scrolls down the page, and stops on the customer question and answer section. There's a search bar at the top of the Q&A section of the page to search the existing questions or ask new questions if your question doesn't exist. There are 4 questions with answers displayed. There are up and down votes to vote on how helpful te answer to the question is. finaly at the bottom of the page theres a button to view all previous posts. Robert searches the post to answer the questions he has about the phone.</p>
